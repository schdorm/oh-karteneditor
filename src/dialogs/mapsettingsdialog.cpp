...
{
  #ifdef DEBUG_MAPPROPERTIES
  qWarning() << "void MapSettingsDialog::backgroundFileDialog()";
  #endif 
  QString dir;
  ...
  #ifdef DEBUG_MAPPROPERTIES
  qWarning() << "End of:\"void MapSettingsDialog::backgroundFileDialog()\"" << f_bgf;
  #endif 
...
{
  #ifdef DEBUG_MAPPROPERTIES
  qWarning() << "void MapSettingsDialog::northmapFileDialog()";
  #endif 
  QString dir;
  ...
  #ifdef DEBUG_MAPPROPERTIES
  qWarning() << "End of:\"void MapSettingsDialog::northmapFileDialog()\"" << f_mf;
  #endif 
}
...
void MapFrame::mapSettingsDialog()
{
  m_MapDialog = new MapSettingsDialog(map());
  m_MapDialog->show();
  
  connect(m_MapDialog, SIGNAL(finished(int)), this, SLOT(closeMapSettingsDialog(int)));
}

void MapFrame::closeMapSettingsDialog(int f_result)
{
  #ifdef DEBUG_MAPPROPERTIES
  qWarning() << "void MapFrame::closeMapSettingsDialog()" << f_result;
  #endif
  
  if(f_result == 1)
  {
    m_MapDialog->setMapProperties();
    m_MapDialog->setCityProperties();
    setMap(m_MapDialog->map());
    applyMapSettings();
    emit mapChanged();
  }
  #ifdef DEBUG_MAPPROPERTIES
  ...
  #ifdef DEBUG_MAPPROPERTIES
  qWarning() << "End of \"void MapFrame::closeMapSettingsDialog(int f_result)\"!";
  #endif
}
